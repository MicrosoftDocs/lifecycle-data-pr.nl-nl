...
---
# <a name="lifecycle-data-export"></a>Levenscyclusgegevens exporteren

## <a name="export-all-products"></a>Alle producten exporteren
Exporteer de levenscyclusgegevens voor alle producten door hieronder te klikken:

> [!div class="nextstepaction"]
> [Alle producten exporteren](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a>Producten per familie en groep exporteren
Selecteer een familie en vervolgens een groep om te exporteren. Opmerking: Het exporteren begint wanneer de groepswaarde is geselecteerd. 
...
## <a name="export-products-by-end-of-support-date"></a>Exporteer producten op het einde van de ondersteuningsdatum
Selecteer een jaar om producten te zien die het einde van de ondersteuning bereiken. Opmerking: Het exporteren begint wanneer de waarde Jaar is geselecteerd.
