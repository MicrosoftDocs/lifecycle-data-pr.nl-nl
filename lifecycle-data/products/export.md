...
ms.locfileid: "940816"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="18e3f-103">Levensduur gegevensexport</span><span class="sxs-lookup"><span data-stu-id="18e3f-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="18e3f-104">Deze pagina wordt momenteel ontwikkeld.</span><span class="sxs-lookup"><span data-stu-id="18e3f-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="18e3f-105">Alle producten exporteren</span><span class="sxs-lookup"><span data-stu-id="18e3f-105">Export all products</span></span>
<span data-ttu-id="18e3f-106">Export levensduur gegevens voor alle producten door hieronder te klikken:</span><span class="sxs-lookup"><span data-stu-id="18e3f-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="18e3f-107">Alle producten exporteren</span><span class="sxs-lookup"><span data-stu-id="18e3f-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="18e3f-108">Producten exporteren op basis van familie en groep</span><span class="sxs-lookup"><span data-stu-id="18e3f-108">Export products by Family and Group</span></span>
<span data-ttu-id="18e3f-109">Selecteer een familie en vervolgens een groep die u wilt exporteren.</span><span class="sxs-lookup"><span data-stu-id="18e3f-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="18e3f-110">Opmerking: exporteren begint wanneer groepswaarde is geselecteerd.</span><span class="sxs-lookup"><span data-stu-id="18e3f-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="18e3f-171">Producten exporteren vanaf het einde van de ondersteunings datum</span><span class="sxs-lookup"><span data-stu-id="18e3f-171">Export products by end of support date</span></span>
<span data-ttu-id="18e3f-172">Selecteer een jaar om producten te zien die het einde van de ondersteuning bereiken.</span><span class="sxs-lookup"><span data-stu-id="18e3f-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="18e3f-173">Opmerking: de export begint wanneer de waarde Year is geselecteerd.</span><span class="sxs-lookup"><span data-stu-id="18e3f-173">Note: Export will begin when Year value is selected.</span></span>
